...
var resolutions = ['qvga', 'vga', 'shd', 'hd', 'single', 'nine' 'fhd', 'qhd'];
...
var videoConstraints = <String, VideoConstraints>{
  ...
  'vga': VideoConstraints(
      constraints: MediaTrackConstraints(
          width: 640, height: 360, frameRate: FrameRate(ideal: 24, max: 30)),
  ...
  // 'hd': VideoConstraints(
  //     constraints: MediaTrackConstraints(
  //         width: 640, height: 360, frameRate: FrameRate(ideal: 15, max: 30)),
  //     encodings: RTCRtpEncoding(maxBitrate: 120000, maxFramerate: 25)),
  // 'single': VideoConstraints(
  //     constraints: MediaTrackConstraints(
  //         width: 1280, height: 720, frameRate: FrameRate(ideal: 30, max: 45)),
  //     encodings: RTCRtpEncoding(maxBitrate: 2500000, maxFramerate: 30)),
  // 'nine': VideoConstraints(
  //     constraints: MediaTrackConstraints(
  //         width: 420, height: 360, frameRate: FrameRate(ideal: 20, max: 20)),
  //     encodings: RTCRtpEncoding(maxBitrate: 100000, maxFramerate: 20)),
  'hd': VideoConstraints(
      constraints: MediaTrackConstraints(
          width: 1280, height: 720, frameRate: FrameRate(ideal: 30, max: 60)),
      encodings: RTCRtpEncoding(maxBitrate: 2500000, maxFramerate: 60)),
  'fhd': VideoConstraints(
      constraints: MediaTrackConstraints(
          width: 1920, height: 1080, frameRate: FrameRate(ideal: 30, max: 60)),
      encodings: RTCRtpEncoding(maxBitrate: 4000000, maxFramerate: 60)),
